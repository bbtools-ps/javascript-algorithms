...
/**
 * Fixes runts in a paragraph by replacing the last whitespace with a non-breaking space
 * @param {string} str - The paragraph text to process
 * @returns {string} The text with runts fixed using &nbsp;
 */
